...
def callback(msg):
    ...
    while (count < 1):
        ...
        # print "Robot moving"
        if flag == 0:
            position1 = str("movej(p[" + str(msg.X) + "," + str(msg.Y) + "," + str(msg.Z) + ","+ str(msg.Rx) + "," + str(msg.Ry) + "," + str(msg.Rz) + "], a=1.0, v=0.3)")
            s.send(position1 + "\n")
            time.sleep(1)
            # print position1
            print "Flag is 0"
            ...
            position2 = str("movej([" + str(msg.base) + "," + str(msg.shoulder) + "," + str(msg.elbow) + ","+ str(msg.w1) + "," + str(msg.w2) + "," + str(msg.w3) + "], a=1.0, v=0.3)")
            s.send(position2 + "\n")
            time.sleep(1)
            # print position2
            print "Flag is 1"
